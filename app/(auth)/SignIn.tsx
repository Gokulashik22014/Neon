  ...
  const submit = async () => {
    try {
      if (!email || !password) {
        ...
        const newUser=await sigin(email,password)
  ...
  return (
    <SafeAreaView className="bg-primary h-full">
      <ScrollView>
        <View className="min-h-[85vh] justify-center px-4">
          ...
          <View className="flex-row space-x-3 items-center mb-5">
            ...
            <Text className="text-white text-xl">
              <Text className="text-secondary-100">Sign In</Text> with your
              account
            </Text>
          </View>
          <FormField
        ...
        <Text className="text-white font-pbold text-sm text-center mt-7">Don't have an account? <Link href={"/SignUp"} className="text-secondary-200">Sign Up</Link></Text>
        </View>
